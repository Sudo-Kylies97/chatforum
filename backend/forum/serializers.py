...
class PostSerializer(serializers.ModelSerializer):
    ...
    def get_ai_moderation_score(self, obj):
        return self._moderator_value(obj, "ai_moderation_score")

    def get_ai_moderation_rationale(self, obj):
        return self._moderator_value(obj, "ai_moderation_rationale")

    def get_ai_needs_review(self, obj):
        return self._moderator_value(obj, "ai_needs_review")
