...
@Component({selector:'app-root',standalone:true,changeDetection:ChangeDetectionStrategy.OnPush,imports:[AppHeaderComponent,PostCardComponent,PostComposerComponent,TokenManagerComponent],templateUrl:'./app.component.html'})
